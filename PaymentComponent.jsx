...
function PaymentComponent() {
    ...
    function generateTransferFee(e) {
        ...
        document.getElementById("transferFee").value = 0.25 * amount;
    }
    ...
    function handleSubmit(e) {
        ...
        transaction["inamount"] = Number(currencyamount) + Number(transferfees);
        transaction["transferdate"] = new Date().toJSON().slice(0, 10);

        console.log(transaction)
        // fetch("http://localhost:8080/customer/checkBlacklist" + receiveraccountholdername).then(response => response.json())
        //     .then(result => {
        //         if (result === true) {
                    
                    axios.post("http://localhost:8080/all", transaction,
                       )
                        .then((response) => {
                            console.log("status");
                ...
                <div className="child">
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <input type="number" className="form-control" id="accountNumber" name="accountNumber" required />
